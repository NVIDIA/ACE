...
try:
    ...
    logger.info(f"Successfully loaded config with threshold: {config.RAGMultimodalResponseProcessor.confidence_threshold}")
    ...
    config.RAGMultimodalResponseProcessor = type('RAGMultimodalResponseProcessorConfig', (), {'confidence_threshold': DEFAULT_CONFIDENCE_THRESHOLD})()
    logger.info(f"Using default confidence threshold: {DEFAULT_CONFIDENCE_THRESHOLD}")

class RAGMultimodalResponseProcessor(FrameProcessor):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.confidence_threshold = config.RAGMultimodalResponseProcessor.confidence_threshold
        self.top_n = config.RAGMultimodalResponseProcessor.top_n
        logger.info(
            f"Initialized RAGMultimodalResponseProcessor with confidence threshold: {self.confidence_threshold}, "
