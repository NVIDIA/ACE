  ...
  value = {
    ...
    clusters = {
      ...
      cluster => {
        ...
        ui_storage = {
          ui_storage_account_name = var.clusters[cluster].private_instance ? local.ui_storage_account_name : null
          ui_storage_access_client_id =  var.clusters[cluster].private_instance ? local.ui_storage_access_client_id : null
        }
        platform = {
