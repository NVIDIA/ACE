...
settings = {
    "namespace": "default", # kubernetes namespace which your app is deployed
    "ace_controller": { 
...
node_port_settings = { 
    ...
    "redis-timeseries-redis-timeseries-svc": [
...
deployments = { 
    ...
    "tokkio-ui-deployment": {
        "container": "ucf-svc-tokkio-ui-container",
        "env_list": [
            {
